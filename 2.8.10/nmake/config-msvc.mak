...
NUSPELL_DIR=$(PREFIX)
!endif
!ifndef NUSPELL_INCLUDEDIR
NUSPELL_INCLUDEDIR=$(NUSPELL_DIR)\include
!endif
!ifndef NUSPELL_LIBDIR
NUSPELL_LIBDIR=$(NUSPELL_DIR)\lib
!endif
!ifndef NUSPELL_BINDIR
NUSPELL_BINDIR=$(NUSPELL_DIR)\bin
!endif
...
ENCHANT_NUSPELL_INCLUDES =	\
	$(LIBENCHANT_INCLUDES)	\
	/I$(NUSPELL_INCLUDEDIR)
...
ENCHANT_NUSPELL_DLL = vs$(VSVER)\$(CFG)\$(PLAT)\enchant_nuspell.dll
